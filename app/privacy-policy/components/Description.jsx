...
const Description = () => {
  return (
    <div className='bg-[#FFEFCF]'>
      <div className="container mx-auto h-[400px] justify-center flex flex-col ">
